...
function magic8Ball()
{
  echo "Welcome to the Magic 8 Corridor! Enter a question and receive your answer. \nHint: Only ask yes or no questions. \n"; 
  $question = readline(">> ");
  echo "You asked: {$question}. Please wait while we retrieve your answer. \n";
  echo "Retrieving... \n";
  sleep(4);
